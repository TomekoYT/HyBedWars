...
object HeightLimitRenderer {
    ...
    private fun onWorldRender(
        ...
        if (!HyBedWarsConfig.heightOverlay || !HypixelPackets.inBedwars) return
        ...
        syncCacheRegion(map, targetY, level, playerX, playerZ)
    ...
    private fun renderCachedOverlay(
        ...
        val alpha = HyBedWarsConfig.heightOverlayOpacity.toFloat() / 100f
